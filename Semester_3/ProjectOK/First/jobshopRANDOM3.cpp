...
void saveAns(Ans* ans)
{
    ...
    int Sum = ans->Odp[0], Maxx = ans->Odp[0], Minn = ans->Odp[0];
    double Sr;
    ...
    cout<<"Max: "<<Maxx<<" "<<"Min: "<<Minn<<" "<<"Sr: "<<Sr<<endl;
